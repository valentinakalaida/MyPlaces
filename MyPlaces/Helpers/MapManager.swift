...
//  MyPlaces
//
//  Created by Валентина Калайда on 03.02.2020.
...
class MapManager {
    ...
    func checkLocationServices(mapView: MKMapView, segueIdentifier: String, closure: () -> ()) {
        ...
        if CLLocationManager.locationServicesEnabled() {
            ...
            DispatchQueue.main.asyncAfter(deadline: .now()+1) {
                self.showAlert(title: "Location is disabled", message: "Please let the app observe your location in settings")
            }
        }
    }
    ...
    func checkLocationAutorization(mapView: MKMapView, segueIdentifier: String) {
        ...
        case .authorizedWhenInUse:
            ...
            break
        case .denied:
             showAlert(title: "Location is disabled", message: "Please let the app observe your location in settings")
            break
        case .notDetermined:
    ...
    private func showAlert(title: String, message: String) {
           ...
           let alert = UIAlertController(title: "Location is disabled", message: "Please let the app observe your location in settings", preferredStyle: .alert)
